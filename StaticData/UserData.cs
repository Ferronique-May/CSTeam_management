...
namespace Website.StaticData
{
    public class UserData
    {
        ...
        {
            new UserModel() { UserId = 1, Email = "email@what.creativity", Password = SecurePasswordHasherHelper.Hash("Hashed"), FullName = "Tom Scott", Role = "t" },
            new UserModel() { UserId = 2, Email = "email@example", Password = SecurePasswordHasherHelper.Hash("exe"), FullName = "Minion", Role = "admin" },
